        ...
        <div class="col-lg-3 col-md-3 col-sm-3" id="menuListBG">
            <div class="btn-group-vertical" role="group" id="menuList">
                <button type="button" class="btn btn-default">
                    <a href="{{url('manager/fee/meal')}}"><p>伙食</p></a>
                </button>
                <button type="button" class="btn btn-defaulti active">
                    <a href="{{url('manager/fee/dorm')}}"><p>宿舍</p></a>
                </button>
                <button type="button" class="btn btn-default">
                    <a href="{{url('manager/fee/parking')}}"><p>停車費</p></a>
                </button>
                <button type="button" class="btn btn-default">
                    <a href="{{url('manager/fee/attendance')}}"><p>值班</p></a>
                </button>
                <button type="button" class="btn btn-default">
                    <a href="{{url('manager/fee/weekendAttendance')}}"><p>假日值班</p></a>
                </button>
            </div>
        </div>
